...
<body>
	<div
		style="background-color: white; width: 500px; margin: 20px; padding: 20px; height: 1000px; margin: auto; padding: 50px;">
			...
			<form action="login.js" method="get">
				<fieldset>
					...
					<div class="text-center">
						<input type="submit" class="btn btn-lg" value="처음으로"
							style="width: 400px; margin: 100px 0 30px 0;">
					</div>
