	...
	<div
		...
		<form action="login.js" method="post"
			...
			<fieldset>
				...
				<div style="margin: 10px;">
					<input type="password" id="userpw" name="user_pass" placeholder="비밀번호"
						style="width: 500px; height: 50px; border-radius: 10px; padding: 20px;">
				</div>
				<div class="text-left" style="margin: 20px 0px 20px 110px;">
		...
		<div
			...
			<div style="margin-right: 10px;">
				<p>
					<a
						href=""
						title="KAKAO LOGIN"><img src="resources/image/kakao_login.png"
						alt="login" style="width: 180px; height: 40px;"></a>
				</p>
				<p>
					<a href="#" title="naver login"><img src="resources/image/naverLogin.png"
						style="width: 180px; height: 40px;"></a>
				</p>
			</div>
			<div>
				<p>
					<a href="#" title="naver login"><img src="resources/image/appleLogin.png"
						style="width: 180px; height: 40px;"></a>
				</p>
				<p>
					<a href="#" title="google login"><img
						src="resources/image/googleLogin.png" style="width: 180px; height: 40px;"></a>
				</p>
			</div>
